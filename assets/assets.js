...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'PHP, Java, JavaScript, Python, C++, C#, SQL' },
...
export const toolsData = [
    assets.vscode, assets.jupyterlab, assets.wordpress, assets.figma, assets.mysqlworkbench
];